...
public class ApiManager {
    ...
    public static void getAllTasks(String projectId, Callback<ValidateModel<List<TaskInfo>>> callback){
        Call<ValidateModel<List<TaskInfo>>> getTasks = serverApi.getAllTasks(Utility.getAccessToken(),projectId);
